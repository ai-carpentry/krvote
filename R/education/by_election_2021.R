...
nec_url <- glue::glue("http://info.nec.go.kr/electioninfo/electionInfo_report.xhtml?",
                       ...
                       "&secondMenuId=VCCP04",
                       "&menuId=VCCP04",
                       "&statementId=VCCP04_%232_0",
                       "&oldElectionType=1",
                       "&electionType=4",
                       "&electionName=20210407",
                       "&electionCode=3",
                       "&cityCode=1100",
                       "&sggCityCode=-1",
                       "&townCodeFromSgg=-1",
...
by_election_2021 <- krvote::clean_varnames(by_election_2021)

usethis::use_data(by_election_2021, overwrite = TRUE)

# sinew::makeOxygen(by_election_2021)
